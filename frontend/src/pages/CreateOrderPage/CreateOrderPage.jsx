...
const CreateOrderPage = () => {
  ...
  const validateForm = (formData) => {
    ...
    if (!internalNum || internalNum.trim() === '') {
      errors.internalNumOrders = 'Внутренний номер заказа обязателен';
    } else if (isNaN(internalNum) || internalNum <= 0) {
